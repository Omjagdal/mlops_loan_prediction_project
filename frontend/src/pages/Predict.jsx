...
export default function Predict() {
  ...
  // Affordability score (new V2 feature preview)
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit}>
        {/* Personal */}
        <div className="glass-card animate-fade-up" style={{ marginBottom: '24px', animationDelay: '100ms' }}>
        ...
        {/* Financial */}
        <div className="glass-card animate-fade-up" style={{ marginBottom: '24px', animationDelay: '200ms' }}>
        ...
        {/* Loan Details */}
        <div className="glass-card animate-fade-up" style={{ marginBottom: '24px', animationDelay: '300ms' }}>
        ...
        {error && (
          <div className="glass-card" style={{ marginBottom: '24px', borderColor: 'rgba(255,107,107,0.3)', background: 'rgba(255,107,107,0.05)' }}>
            <p style={{ color: 'var(--danger)', textAlign: 'center', fontWeight: '500' }}>{error}</p>
          </div>
        )}

        <div style={{ display: 'flex', gap: '16px', justifyContent: 'center' }}>
          <button type="submit" className="btn btn-primary btn-lg" disabled={loading} style={{ minWidth: '260px' }}>
            {loading ? (<><span className="spinner" style={{ width: '20px', height: '20px', margin: 0, borderWidth: '2px' }} /> Analyzing...</>) : 'Analyze Application'}
          </button>
          <button type="button" className="btn btn-secondary btn-lg" onClick={() => setForm(initialForm)}>Reset</button>
        </div>
      </form>
    </motion.div>
  )
